...
ALLOWED_USERS = [719910511, 997412998, 1097397831, 771104718, 375577548, 837149325, 737740550]  
...
@dp.message_handler(commands=["start"])
async def start_command(message: types.Message):
    await message.reply("👋 Привет! Я бот для управления задачами. Используйте кнопки ниже:")
